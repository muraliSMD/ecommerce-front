      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        {activeTab === "financial" && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-3 pb-6 border-b border-gray-100 mb-2">
                    <h3 className="font-bold text-gray-900 mb-4">Payment Methods</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center justify-between bg-surface p-4 rounded-2xl border border-gray-100">
                            <div>
                        ...
                        <div className="flex items-center justify-between bg-surface p-4 rounded-2xl border border-gray-100">
                            <div>
                                ...
                                <p className="text-xs text-gray-400">Accept Credit Cards, UPI, etc.</p>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input 
                                    type="checkbox" 
                                    checked={settings.paymentMethods?.online ?? true}
                                    onChange={(e) => setSettings({
                                        ...settings,
